...
- 16/11: Added notes and  clarifications (marked as (**\***)) to `2.2.3`, `2.2.4`, `2.3.2`, `2.4.1`, `2.4.2`, `2.4.3`, `2.5.1` and `2.5.2`
...
* A screen of all of YOUR listings (that you created) is displayed, where each listing shows the:
	- Title **DONE**
	- Property Type **DONE**
	- Number of **beds** (not bedrooms) **DONE**
	- Number of bathrooms **DONE**
	- Thumbnail of the listing **DONE**
	- SVG rating of the listing (based on user ratings) **DONE**
	- Number of total reviews **DONE**
	- Price (per night) **DONE**
...
* On the hosted listing screen (`2.2.1`) a button should exist that allows you to create a new listing. When you click on it, you are taken to another screen that requires you to provide the following details:
	- Listing Title
	- Listing Address (street address, suburb, city, state, zip, country)
